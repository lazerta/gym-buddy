...
expected={'queued_preparation_cannot_reopen_closed_runtime','selection_leaves_ui_thread_free','selection_failure_rolls_back_and_retries','reset_targets_selected_equipment','new_workout_failure_is_atomic','completion_uses_durable_set_count'}
